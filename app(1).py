...
try:
    ...
    raise RuntimeError(
        "Could not load GEMINI_API_KEY. "
        "Set it as an environment variable or adapt this section for your environment."
    ) from e
...
def real_time_developer(state: CrewState):
    ...
    dev_prompt = (
        ...
        "Only return the code, with no explanation or markdown formatting."
    )
